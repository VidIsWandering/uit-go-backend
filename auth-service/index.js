...
console.log("Auth Service started. JWT_SECRET length:", JWT_SECRET.length);

// Self-test: Generate and verify a token
const testToken = jwt.sign({ sub: "test" }, JWT_SECRET, { algorithm: "HS384" });
console.log("Test Token generated by Node:", testToken);
try {
  jwt.verify(testToken, JWT_SECRET);
  console.log("Test Token verified successfully");
} catch (e) {
  console.error("Test Token verification failed:", e.message);
}
